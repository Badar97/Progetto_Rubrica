...
class RubricaGUI:
    ...
    def crea_toolbar(self):
        ...
        nuovo_btn_img = Image.open("nuovo_icon.png").resize((20, 20), Image.ANTIALIAS)
        ...
        modifica_btn_img = Image.open("modifica_icon.png").resize((20, 20), Image.ANTIALIAS)
        ...
        elimina_btn_img = Image.open("elimina_icon.png").resize((20, 20), Image.ANTIALIAS)
